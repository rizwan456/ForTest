...
public class CustomLoadControl implements LoadControl {
     ...
     */
    public static final int DEFAULT_MIN_BUFFER_MS = 90000;

    /**
     * The default maximum duration of media that the player will attempt to buffer, in milliseconds.
     */
    public static final int DEFAULT_MAX_BUFFER_MS = 150000;
    ...
    public static final int DEFAULT_BACK_BUFFER_DURATION_MS = 90000;
